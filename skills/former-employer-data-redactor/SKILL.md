---
name: former-employer-data-redactor
...
若用户要完整建设作品集，由 `career-portfolio-builder` 统一管理网站、知识库、Word、图表和生成源；本Skill的删除决定必须写入共享决策账本，并同步到所有载体、生成源与rejected_claims，防止旧版本再次恢复。
